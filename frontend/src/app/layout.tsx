...
const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/citas",     icon: "📅", label: "Citas",     key: "citas",     iconBg: "linear-gradient(145deg,#3730a3,#6366f1)", iconShadow: "0 4px 12px rgba(99,102,241,0.55),inset 0 1px 0 rgba(255,255,255,0.25)" },
