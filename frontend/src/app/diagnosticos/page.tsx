...
const TIPOS_SERVICIO = [
  "CAMBIO DE ACEITE", "PERDIDA DE POTENCIA", "CONSUMO EXCESIVO DE COMBUSTIBLE", "ALINEACIÓN Y BALANCEO", "FRENOS", "SUSPENSIÓN",
  "SISTEMA ELÉCTRICO", "SISTEMA ELECTRÓNICO / SCANNER", "TRANSMISIÓN",
  "MOTOR", "AIRE ACONDICIONADO", "DIAGNÓSTICO GENERAL", "CHEQUEO DE BUJIAS", "OTRO"
];
